...
- 생성기: `tools/assets/build_city_icons.py`, `tools/assets/build_status_icons.py`, `tools/assets/build_ui_icons.py`
- preview: `assets/brand/{city-icons,status-icons,ui-icons}/preview.png`
- export: `web/{game,gateway}/public/{city,status,icons}/`
